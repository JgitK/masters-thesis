...
```
    ...
    ## R2                                                                          0.026               
    ## Adjusted R2                                                                 0.021               
    ## Log Likelihood                       -1,241.834  -1,277.665                                     
...
```
    ...
    ## Residual Std. Error                                                    0.319 (df = 4023)         
...
```
    ...
    ## R2                                                                                            0.045               
    ## Adjusted R2                                                                                   0.040               
    ## Log Likelihood                                         -1,201.195  -1,712.944                                     
...
```
    ...
    ##                                     Dependent variable:               
    ##                      -------------------------------------------------
    ##                      over_reported_intention       did_you_vote       
    ##                             logistic                    OLS           
    ##                                (1)                      (2)           
    ## ----------------------------------------------------------------------
    ## education                   -0.182***                 0.0002          
    ##                              (0.045)                  (0.001)         
    ##                                                                       
    ## income                       0.100**                   0.002          
    ##                              (0.039)                  (0.001)         
    ...
    ##                              (0.152)                  (0.005)         
    ##                                                                       
    ## other_non_White1              0.009                  -0.023***        
    ##                              (0.156)                  (0.006)         
    ##                                                                       
    ## church_attendance           0.180***                 0.003***         
    ##                              (0.039)                  (0.001)         
    ##                                                                       
    ## age_cat2                     0.471**                  -0.007          
    ##                              (0.210)                  (0.007)         
    ##                                                                       
    ## age_cat3                    0.793***                  0.012*          
    ##                              (0.210)                  (0.007)         
    ##                                                                       
    ## age_cat4                    0.869***                   0.011          
    ##                              (0.216)                  (0.007)         
    ##                                                                       
    ## age_cat5                     0.462**                   0.006          
    ##                              (0.194)                  (0.006)         
    ##                                                                       
    ## female1                       0.092                   0.006*          
    ##                              (0.092)                  (0.003)         
    ##                                                                       
    ## ideological_strength          0.080                  0.005***         
    ##                              (0.058)                  (0.002)         
    ##                                                                       
    ## political_interest          0.211***                 0.014***         
    ##                              (0.056)                  (0.002)         
    ##                                                                       
    ## Constant                     0.467*                  0.936***         
    ##                              (0.254)                  (0.008)         
    ##                                                                       
    ## ----------------------------------------------------------------------
    ## Observations                  4,167                    4,166          
    ## R2                                                     0.035          
    ## Adjusted R2                                            0.033          
    ## Log Likelihood             -1,740.788                                 
    ## Akaike Inf. Crit.           3,507.576                                 
    ## Residual Std. Error                              0.088 (df = 4153)    
    ## F Statistic                                  12.701*** (df = 12; 4153)
    ## ======================================================================
    ## Note:                                      *p<0.1; **p<0.05; ***p<0.01
...
```
    ...
    ##                factor     AME     SE       z      p   lower   upper
    ##              age_cat2 -0.0074 0.0067 -1.1124 0.2660 -0.0205  0.0057
    ##              age_cat3  0.0116 0.0067  1.7387 0.0821 -0.0015  0.0248
    ##              age_cat4  0.0110 0.0068  1.6034 0.1088 -0.0024  0.0243
    ##              age_cat5  0.0058 0.0061  0.9505 0.3419 -0.0062  0.0179
    ##                Black1 -0.0044 0.0048 -0.9245 0.3552 -0.0138  0.0050
    ##     church_attendance  0.0034 0.0012  2.7741 0.0055  0.0010  0.0058
    ##             education  0.0002 0.0014  0.1342 0.8933 -0.0026  0.0030
    ##               female1  0.0057 0.0030  1.9029 0.0571 -0.0002  0.0116
    ##  ideological_strength  0.0054 0.0019  2.8213 0.0048  0.0016  0.0091
    ##                income  0.0016 0.0013  1.2416 0.2144 -0.0009  0.0041
    ##      other_non_White1 -0.0231 0.0056 -4.1591 0.0000 -0.0340 -0.0122
    ##    political_interest  0.0138 0.0020  7.0820 0.0000  0.0100  0.0176
...
```
    ...
    ##                                   (1)                    (2)         
    ## ---------------------------------------------------------------------
    ## social_media_engagement          -0.008                 -0.005       
    ##                                 (0.005)                (0.005)       
    ##                                                                      
    ## education                      -0.028***                             
    ##                                 (0.007)                              
    ...
    ##                                 (0.014)                              
    ##                                                                      
    ## political_interest               0.012                               
    ##                                 (0.012)                              
    ##                                                                      
    ## Constant                        0.730***               0.857***      
    ##                                 (0.049)                (0.014)       
    ##                                                                      
    ## ---------------------------------------------------------------------
    ## Observations                     2,862                  2,877        
    ## R2                               0.023                  0.0004       
    ## Adjusted R2                      0.018                 0.00004       
    ## Residual Std. Error        0.360 (df = 2847)      0.363 (df = 2875)  
    ## F Statistic             4.706*** (df = 14; 2847) 1.118 (df = 1; 2875)
    ## =====================================================================
    ## Note:                                     *p<0.1; **p<0.05; ***p<0.01
